...
export default function ColorBends({
  ...
  // tracks visibility to skip GPU work when off-screen
  ...
  useEffect(() => {
    ...
    // dpr=1: on Retina this saves 75% fragment shader work for a bg effect
    ...
    // pause GPU work when the hero scrolls off-screen
